      ...
      <div className="space-y-8 select-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {/* Account Card */}
            <div className="bg-slate-900 border-4 border-double border-slate-700 rounded-2xl p-6 shadow-lg space-y-6">
              ...
              {player ? (
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full h-4 bg-slate-950 border border-slate-800 rounded-full overflow-hidden p-0.5 relative">
                      <div
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="bg-slate-950 border border-slate-800 rounded-2xl p-3 text-center">
                      <span className="block text-slate-550 text-[10px] font-bold">TÀI SẢN XU VÀNG</span>
                      <span className="text-lg font-retro text-coin mt-0.5 block">💰 {player.coins.toLocaleString()}</span>
                    </div>
                    <div className="bg-slate-950 border border-slate-800 rounded-2xl p-3 text-center">
                      <span className="block text-slate-550 text-[10px] font-bold">KIM CƯƠNG QUÝ</span>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-950 border border-slate-800 rounded-2xl">
                  <div className="space-y-0.5">
                    <h4 className="font-bold text-sm text-white">Nhạc nền (BGM)</h4>
                  ...
                  <button
                    ...
                    className={`w-14 h-8 rounded-full p-1 transition-colors duration-200 ease-in-out cursor-pointer ${
                      bgmEnabled ? "bg-cta" : "bg-slate-800"
                    }`}
                  >
                    <div
                ...
                <div className="flex items-center justify-between p-4 bg-slate-950 border border-slate-800 rounded-2xl">
                  <div className="space-y-0.5">
                    <h4 className="font-bold text-sm text-white">Hiệu ứng âm thanh (SFX)</h4>
                    <p className="text-xs text-slate-400 font-semibold">Âm thanh click nút bấm, bày hàng, thu tiền</p>
                  </div>
                  <button
                    onClick={toggleSfx}
                    className={`w-14 h-8 rounded-full p-1 transition-colors duration-200 ease-in-out cursor-pointer ${
                      sfxEnabled ? "bg-cta" : "bg-slate-800"
                    }`}
                  >
                    <div
                      className={`w-6 h-6 rounded-full bg-white shadow-md transform transition-transform duration-200 ease-in-out flex items-center justify-center ${
          ...
          <div className="space-y-6">
            ...
            {/* Version & Info Card */}
            <div className="bg-slate-900 border-4 border-double border-slate-700 rounded-2xl p-6 shadow-lg space-y-5">
              <h3 className="font-bold text-xl text-white flex items-center gap-2.5">
              ...
              <div className="space-y-4 text-xs font-semibold text-slate-350">
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                  <span className="text-slate-500">Tên Trò Chơi</span>
                  <span className="font-bold text-white">Hàng Rong Remix</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                  <span className="text-slate-500">Phiên Bản</span>
                  <span className="font-bold text-white font-retro text-[10px]">v1.2.0-prod</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                  <span className="text-slate-500">Máy Chủ</span>
                ...
                <div className="flex justify-between items-center py-2 border-b border-slate-800">
                  <span className="text-slate-500">Động Cơ Đồ Họa</span>
                  <span className="font-bold text-white">Pixi.js v8 + React</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-slate-500">Bản Quyền</span>
                  <span className="font-bold text-white">© 2026 Hang Rong Team</span>
                </div>
              </div>

              <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 text-center space-y-1">
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Lấy cảm hứng từ</p>
                <h5 className="font-bold text-slate-200 flex items-center justify-center gap-1">
            ...
            {/* Support/Security */}
            <div className="bg-slate-900 border-4 border-double border-slate-700 rounded-2xl p-6 shadow-lg space-y-4">
